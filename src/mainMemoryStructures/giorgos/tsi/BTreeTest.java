...
public class BTreeTest {
	...
	public static void main(String[] args) {
        ...
        BTree t = new BTree(2); // A B-Tree with minimum degree 2,so degree of the tree is 2*2 = 4.
        // max number of keys : 3 
        // min number of keys : 4/2 - 1  = 1
        // max children of the node : 2*2 = 4
        // min children of the node : 4/2 = 2
